...
CREATE TABLE IF NOT EXISTS `locations` (
  ...
  `floor_number` varchar(10) NOT NULL COMMENT '層架',
  `floor_area_code` varchar(10) DEFAULT NULL COMMENT '層架區碼',
...
CREATE TABLE IF NOT EXISTS `qr_codes` (
  ...
  `floor_level` varchar(10) DEFAULT NULL COMMENT '層架（僅層架類型位置使用）',
